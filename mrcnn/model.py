...
class MaskRCNN(object):
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
        ...
        for i in range(N):
            ...
            full_mask, scored_mask = utils.unmold_mask(masks[i], boxes[i], original_image_shape)
        ...
        scored_masks = np.stack(scored_masks, axis=-1) if scored_masks else np.empty(original_image_shape[:2] + (0,))

        return boxes, class_ids, scores, full_masks, scored_masks
    ...
    def detect(self, images, verbose=0):
        ...
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks, scored_masks =\
